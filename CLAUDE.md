...
**No provenance footer in PR bodies, issue bodies or changelogs.** Do not append `🤖 Generated with …`, `Generated by Claude Code`, a session link, or any other line naming the tool that produced the change. The editorial gate blocks them and the push round is wasted. Agent provenance goes in commit trailers (`Co-Authored-By:`), where it is structured and verifiable rather than unverifiable prose. This applies to every harness, not just this one.
